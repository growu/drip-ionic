...
(function() {
    ...
    'use strict';
    	...
    	InitController.$inject = ["$state", "$log", "$localStorage", "$timeout", "Auth"];
    angular
        .module('drip.app')
...
(function () {
    ...
    LoginController.$inject = ["$http", "$state", "$log", "Loading", "$localStorage", "ENV", "Auth", "OAuth", "isQQInstalled", "isWeiboInstalled"];
    angular
        .module('drip.auth')
...
(function () {
    ...
    RegisterController.$inject = ["$http", "$state", "$localStorage", "Loading", "ENV", "OAuth", "isQQInstalled", "isWeiboInstalled"];
    angular
        .module('drip.auth')
