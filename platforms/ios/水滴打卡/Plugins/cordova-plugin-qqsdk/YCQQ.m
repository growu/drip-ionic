...
//    }
//    else if ([previewImageUrl hasPrefix:@"data:image"])
//    {
//        // a base 64 string
//        NSURL *base64URL = [NSURL URLWithString:url];
//        imgData = [NSData dataWithContentsOfURL:base64URL];
//    }
//    else if ([previewImageUrl rangeOfString:@"temp:"].length != 0)
//    {
//        previewImageUrl =  [NSTemporaryDirectory() stringByAppendingPathComponent:[url componentsSeparatedByString:@"temp:"][1]];
//        imgData = [NSData dataWithContentsOfFile:url];
//    }
//    else
//    {
//        // local file
//        previewImageUrl = [[NSBundle mainBundle] pathForResource:[url stringByDeletingPathExtension] ofType:[url pathExtension]];
//        imgData = [NSData dataWithContentsOfFile:url];
//    }
//    
